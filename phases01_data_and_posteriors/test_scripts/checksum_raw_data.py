'''
Run this script to check that the raw data to be used for preprocessing in
Phase 0 is correct. The MD5 checksum of each data file is computed and
compared to the checksums stored in checksum_raw_data.json.

This script can also be used to update (recompute) checksum_raw_data.json by
